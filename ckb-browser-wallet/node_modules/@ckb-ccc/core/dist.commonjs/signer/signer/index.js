...
const verify_js_2 = require("../doge/verify.js");
const verify_js_3 = require("../evm/verify.js");
const verify_js_4 = require("../nostr/verify.js");
/**
 * @public
 */
var SignerSignType;
    ...
    static async verifyMessage(message, signature) {
        switch (signature.signType) {
            case SignerSignType.EvmPersonal:
                return (0, verify_js_3.verifyMessageEvmPersonal)(message, signature.signature, signature.identity);
            case SignerSignType.BtcEcdsa:
                return (0, verify_js_1.verifyMessageBtcEcdsa)(message, signature.signature, signature.identity);
            ...
            case SignerSignType.NostrEvent:
                return (0, verify_js_4.verifyMessageNostrEvent)(message, signature.signature, signature.identity);
            ...
            case SignerSignType.DogeEcdsa:
                return (0, verify_js_2.verifyMessageDogeEcdsa)(message, signature.signature, signature.identity);
