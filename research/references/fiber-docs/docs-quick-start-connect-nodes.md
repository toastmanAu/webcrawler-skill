Source: https://docs.fiber.world/docs/quick-start/connect-nodes
Saved: 2026-03-18
...
Please visit the releases page to download and use the latest version of fnn.
...
Call the new_invoice API on node2 to generate an invoice
